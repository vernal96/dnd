...
final class CharacterClassControllerTest extends TestCase
{
    ...
    public function test_user_can_get_character_classes_with_subclasses(): void
    {
        ...
        $this->getJson('/api/character-classes', $this->frontendHeaders())
            ...
            ->assertJsonPath('0.skillsByLevel.level1.0.code', 'rage')
            ->assertJsonPath('0.skillsByLevel.level1.0.targetType', 'self')
            ...
            ->assertJsonPath('1.skillsByLevel.level7.0.code', 'countercharm')
            ->assertJsonPath('1.skillsByLevel.level7.0.targetType', 'aoe')
            ->assertJsonPath('1.skillsByLevel.level7.0.radiusCells', 6)
    ...
    public function test_user_can_view_one_character_class_by_code(): void
    {
        ...
        $this->getJson('/api/character-classes/warlock', $this->frontendHeaders())
            ...
            ->assertJsonPath('skillsByLevel.level1.0.code', 'eldritch-invocations')
            ->assertJsonPath('skillsByLevel.level11.0.code', 'mystic-arcanum-6')
